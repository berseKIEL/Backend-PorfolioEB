...
@project_handler.get('/', summary="Obtiene los projectos de un usuario", response_model=List[ProjectOut])
async def list_projects(current_user: User = Depends(get_current_user)):
    return await ProjectService.list_projects(current_user)


@project_handler.post('/create', summary="Crea un proyecto para un usuario", response_model=Project)
...
@project_handler.get('/{project_id}', summary="Obtiene una proyecto por su ID", response_model=ProjectOut)
...
@project_handler.put('/{project_id}', summary="Edita un proyecto de un usuario según su ID", response_model=ProjectOut)
...
@project_handler.delete('/{project_id}', summary="Borra un proyecto de un usuario según su ID")
